...
private:
    ...
    std::string problem_type; // Can be "REGRESSION" or "CLASSIFICATION"
    int input_size;
    int output_size;
    int layers_num = 0;
    // int HL;
...
public:
    ...
    NN(int input_size, int output_size, std::string problem_type);
    NN(const std::string &model_name, int input_size, int output_size);
    NN(const std::string &model_name, int input_size, int output_size, std::string problem_type);
    
    NN(int input_size, int hidden_layers_num, int hidden_layers_dim, int output_size, std::string problem_type);
    NN(const std::string &model_name, int input_size, int hidden_layers_num, int hidden_layers_dim, int output_size);
    NN(const std::string &model_name, int input_size, int hidden_layers_num, int hidden_layers_dim, int output_size, std::string problem_type);
    ...
    float evaluate(const Matrix &x_test, const Matrix &y_test);
