// #ifndef NN_MODEL_BASE_LAYER_H
// #define NN_MODEL_BASE_LAYER_H
...
//     // Methods
//     void initialize(std::unique_ptr<BaseInitializationFunction> initializer);
